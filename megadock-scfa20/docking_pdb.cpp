...
//============================================================================//
{
    ...
    _fft_process  = new FFTProcessPDB(_cputime,_parallel,_parameter,_receptor,_ligand);
...
//============================================================================//
void DockingPDB::alloc_array(const int &natom,const int &nag,const size_t &ng3)
//============================================================================//
{
    const size_t nproc2    = _parallel->nproc2();
...
//============================================================================//
void DockingPDB::create_voxel(Protein<ParameterPDB> *rprotein, size_t myid2)
//============================================================================//
{
    struct timeval et1, et2;
...
//============================================================================//
void DockingPDB::dock_memory_free()
//============================================================================//
{
    const size_t nproc2    = _parallel->nproc2();
...
//============================================================================//
void DockingPDB::ligand_rotationz(float *theta, size_t myid2)
//============================================================================//
{
...
//============================================================================//
void DockingPDB::output_calc_time_log()
//============================================================================//
{
    char buff[4096];
    const int ng1 = _Num_grid;

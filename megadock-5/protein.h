...
template<class T> class Protein : public PDBEntry     // Protein class
{
private:
    friend class  DockingPDB;
    friend class  DockingTable;
    template<class P> friend class  Receptor;
    template<class P> friend class  Ligand;
...
public:
    ...
    virtual void  initialize(T *rparameter);
